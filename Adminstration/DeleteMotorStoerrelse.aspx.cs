...
public partial class Adminstration_DeleteMotorStoerrelse : System.Web.UI.Page
{
    ...
    {
        objcarfac.DeleteMotorStoerelse(int.Parse(ddlStoerelse.SelectedValue.ToString()));
    }
