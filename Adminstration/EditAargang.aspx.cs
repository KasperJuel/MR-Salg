...
public partial class Adminstration_EditAargang : System.Web.UI.Page
{
    ...
    {
        if (txtRedigerAargang.Text != null)
        {
            objcarfac.RedigerAargang(txtRedigerAargang.Text, int.Parse(ddlAargang.SelectedValue));
            litmsg.Text = "<b style='color: green'>Årgang er blevet rettet! (siden refresher om 3 sekunder)</b>";
